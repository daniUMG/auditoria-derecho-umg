...
export default {
    ...
    created(){
        ...
        if(this.$route.params.id) {
            db.collection('grupos').doc(this.$route.params.id).get()
            .then(docGrupo => {
                if(docGrupo.exists) {
                    this.nombre = docGrupo.data().nombre
                    this.descripcion = docGrupo.data().descripcion
                    this.users = docGrupo.data().usuarios
                }
            })
        }
    }
