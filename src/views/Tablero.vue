                    ...
                    <v-card class="mx-auto collection-list" dark max-width="400" min-width="400" :style='`border-radius: initial; border-top: 5px ${item.tema} solid !important; background-color: #fff; color: #3F454C;`'>
                        <v-card-title class="collection-title">
                            <span>
                                ...
                                <svg :fill="`${item.tema}`" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="26" height="26" viewBox="0 0 937.084 937.084" xml:space="preserve" style="position: relative; top: -3px;">
                                    <g>
                                        <g>
